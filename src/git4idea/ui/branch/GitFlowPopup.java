...
/**
 * <p>
 *   The popup which allows to execture gitflow commands
 * </p>
 * <p>
...
class GitFlowPopup  {
    ...
    private GitFlowPopup(@NotNull Project project, @NotNull GitRepository currentRepository) {
        myProject = project;
        ...
        myPopup.setAdText("Gitflow", SwingConstants.CENTER);
    }
    ...
    private class GitBranchActionGroupPopup extends PopupFactoryImpl.ActionGroupPopup {
        public GitBranchActionGroupPopup(@NotNull String title, @NotNull Project project,
            ...
            super(title, GitFlowPopup.this.createActions(), SimpleDataContext.getProjectContext(project), false, false, false, true, null, -1,
